...
void loop() {
  ...
  if (Firebase.getString(ledData, "/car")) {
    Serial.println(ledData.stringData());
    if (ledData.stringData() == "forward") {
    ...
    else if (ledData.stringData() == "left") {
      Serial.println("Left");
      digitalWrite(MOTOR_1_PIN_1, 0);
    ...
    else if (ledData.stringData() == "backRight") {
     ...
     else if (ledData.stringData() == "backLeft") {
      Serial.println("Backward");
      digitalWrite(MOTOR_1_PIN_1, 1);
      digitalWrite(MOTOR_1_PIN_2, 0);
      digitalWrite(MOTOR_2_PIN_1, 0);
  ...
  if (Firebase.getString(ledData, "/Switch")) {
    Serial.println(ledData.stringData());
...
void Dht22() {
  ...
  Firebase.setString(firebaseData, "sensor/Temperature", temp);
  Firebase.setString(firebaseData, "sensor/Humidity", humd);
  //log data
  Firebase.pushString(firebaseData, "log/Temperature", temp);
  Firebase.pushString(firebaseData, "log/Humidity", humd);
  delay(100);
}
